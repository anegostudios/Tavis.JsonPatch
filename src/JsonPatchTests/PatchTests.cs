...
namespace JsonPatchTests
{
    public class PatchTests
    {
        ...
        public void SerializePatchDocument()
        {
            var patchDoc = new PatchDocument( new Operation[]
            {
             ...
             new AddMergeOperation() {Path = new JsonPointer("/a/b/c"), Value = new JArray(new JValue("foo"), new JValue("bar"))}, 
  ...
  'tpHandTransform': {
    ...
    'scale': 0.37
        ...
        public static JToken GetSample4()
        {
            return JToken.Parse(@"{
  'code': 'trough',
  ...
  'materialDensity': 600
        ...
        public static JToken GetSample5()
        {
            return JToken.Parse(@"[
  {
	'bottom-inside': {
